...
#I'm going to check for unique countries in all four datasets 

countries_v_dem <- unique(Formatted_V_Dem$Country)
countries_freedom_house <- unique(Formatted_Freedom_House$Country)
unique_to_v_dem <- setdiff(countries_v_dem, countries_freedom_house)
print("Unique to Formatted_V_Dem:")
...
countries_LIED <- unique(Formatted_LIED$Country)
unique_to_LIED <- setdiff(countries_LIED, countries_freedom_house)
print("Unique to LIED:")
print(unique_to_LIED)
countries_LIED_2 <-unique(Formatted_LIED$Country)
unique_to_LIED_2 <- setdiff(countries_LIED_2, countries_v_dem)
print("Unique to LIED_2:V_DEM")
print(unique_to_LIED_2)

#Since I have 2 datasets from Freedom House, so I'm going to change V_Dem's "United States of America" and "Czechia" to "United States" and "Czech Republic" plus I'm going to change LIED's from "Korea, South" to "South Korea" to match the other datasets   

Formatted_LIED$Country[Formatted_LIED$Country == "Korea, South"] <- "South Korea" 
Formatted_V_Dem$Country[Formatted_V_Dem$Country == "United States of America"] <- "United States"
Formatted_V_Dem$Country[Formatted_V_Dem$Country == "Czechia"] <- "Czech Republic"
