...
#I had to check the columns to determine if they were numeric or character
str(Formatted_Freedom_House_2)

#I have to convert the new column Year into numeric
Formatted_Freedom_House_2$Year <- as.numeric(Formatted_Freedom_House_2$Year)

#confirm one more time before saving
str(Formatted_Freedom_House_2)
...
#I decide to merge the Freedom House datasets first so they it unified dataset.    

Freedom_House_merged <- full_join(Freedom_House_2, Freedom_House, by = c("Country", "Year"))

# I then decide to unit the Freedom House dataset with LEAD.  

Merged_FH_LIED <- merge(Merged_Freedom_House, LIED, by = c("Country", "Year"), all = TRUE)
```
